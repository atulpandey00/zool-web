            ...
            <div className="container mw-1360 px-6 lg:px-12">
                ...
                <div className="text-center mb-8 sm:mb-12">
                    ...
                    <div className="sm:hidden flex flex-col items-center gap-3">
                        ...
                        <h2 className="text-gray-700 text-lg font-medium text-center leading-relaxed">
                            Trusted by Industry Leaders Worldwide
                        </h2>
                    </div>
                </div>
                    ...
                    <div className="flex items-center gap-8 xl:gap-12 min-w-max">
                        {logos.map((logo, index) => (
                            <div key={index} className="flex items-center">
                                ...
                                <div className="grayscale opacity-70 hover:grayscale-0 hover:opacity-100 transition-opacity duration-300">
                                    <Image
                                        src={logo.src}
                                        alt={logo.alt}
                                        width={180}
                        ...
                        <div className="flex animate-scroll-mobile items-center">
                            {[...logos, ...logos].map((logo, index) => (
                                <div key={index} className="flex items-center flex-shrink-0">
                                    {index > 0 && (
                                        <div className="w-px h-12 bg-gray-400 mx-8" />
                                    )}
                                    <div className="grayscale opacity-70 hover:grayscale-0 hover:opacity-100 transition-opacity duration-300">
                                        <Image
                                            src={logo.src}
